...
<template>
    ...
    <Popup :open="open" @close="openDialog = false"/>
        ...
        <div class="mx-auto max-w-2xl text-center">
            ...
            <p class="mt-2 text-lg leading-8 text-white">We are actively onboarding teams to use our tool for free during the beta stage. Don't miss out, reach out!</p>
            <p v-if="errorMessage" class="mt-2 text-lg leading-8 text-red-400">{{ errorMessage }}</p>
        </div>
